...
Run your exact filters and rules against **real Solana data** from the last 7 to 30 days. Not cleaned up data. Not survivorship biased data. Real data, with realistic slippage, failed tokens included, and all the chaos of actual markets.
