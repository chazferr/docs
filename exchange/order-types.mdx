...
Spot orders are routed to AMMs or DEX aggregators. For AMM execution, "limit" behavior is approximated through conditional execution — the transaction reverts if the price exceeds the specified threshold.
