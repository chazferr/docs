...
Omnera routes perpetual futures orders to integrated on-chain venues. The trader interacts with Omnera's unified interface. The underlying execution occurs on the perps venue with the best available conditions for the specific pair and size.
...
| Order types | Market, limit, and stop orders. See [Order Types](/execution/order-types) for details. |
